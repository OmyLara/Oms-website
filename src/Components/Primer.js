    ...
    return (
        ...
        <section className="part-two">
            ...
            <div className="proyectos">
                <div className="p1"><a href="https://marvel-champions-counter.netlify.app"><span ><img src={Marvel} alt="Img Marvel"/><br/></span><h1>Board Game Counter</h1></a><br/><br/><p>You can now play Marvel Champions replacing life counters with this easy app.<br/><br/><a href="http://www.fantasyflightgames.es/juegos/coleccion/marvel_champions" >More about Marvel Champions here.</a></p></div>
